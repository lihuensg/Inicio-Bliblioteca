...
namespace Aplication.IntegrationTests.Consultas
{
    [TestClass]
    public class PorVencerSinNotificarTest : CasoDeUsoTestBase
    {
        ...
        public void PrestamoPorVencer_DeberiaDevolver_SoloElPrestamoPorVencer()
        {
            ...
            Prestamo prestamo_notificar = Prestamo.Crear(usuario, ejemplar1, DateTimeProviderMock.Object);

            DateTimeProviderMock.Setup(x => x.Now).Returns(DateTime.Now.AddDays(diasBase + 12));
            Prestamo prestamo_no_notificar = Prestamo.Crear(usuario, ejemplar2, DateTimeProviderMock.Object);
            ...
            var prestamosANotificar = unit.RepositorioNotificacionVencimientoPrestamo
                .ObtenerPrestamosQueEstenPorVencerYNoSeNotifico(fechaActual, diasAntelacion);

            // Assert
            Assert.AreEqual(2, unit.RepositorioPrestamos.ObtenerTodos().ToList().Count);
        ...
        public async Task PrestamoPorVencer_DeberiaNotificar_YLuegoNoDeberiaDevolverNingunoAsync()
        {
            ...
            notificadorMock.Setup(x => x.EnviarGenerico(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<Usuario>()))
                            .Returns(true)
                            .Verifiable();
            ...
            var tareaEnviarAviso = new EnviarAvisosADiasDelVencimiento(diasAntelacion,
            ...
            var aNotificar = UnitOfWorkFactory.Crear().RepositorioNotificacionVencimientoPrestamo
                .ObtenerPrestamosQueEstenPorVencerYNoSeNotifico(DateTimeProviderMock.Object.Now, diasAntelacion);

            // Assert
            notificadorMock
                .Verify(x =>
                        x.EnviarGenerico(It.IsAny<string>(),
                                         It.IsAny<string>(),
